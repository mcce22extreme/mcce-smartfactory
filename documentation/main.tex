...
%--------------------------------------------------------------------------- 
\geometry{tmargin=1.8cm,rmargin=3cm,lmargin=3cm,bmargin=0.6cm,headheight=50pt,includeheadfoot, headsep=2cm}
\usepackage{everysel} 
\onehalfspacing
%adi
...
\input{Grundstruktur/versinfo.tex}
...
\setcounter{page}{1}
\input{Grundstruktur/Introduction}
\input{Grundstruktur/UseCases}
\input{Grundstruktur/Framework}
\input{Grundstruktur/Implementation}
\input{Grundstruktur/Challenges}
%	\begin{comment}
